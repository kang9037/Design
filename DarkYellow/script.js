...
const whyCardData = {
    1: {
        title: '검증된 시스템',
        subtitle: '150개 이상의 학원에서 신뢰하는 플랫폼',
        text: '입시 네비게이션은 2020년부터 전국 150개 이상의 학원에서 사용되고 있는 검증된 학원 관리 시스템입니다. 단순히 시스템을 제공하는 것을 넘어, 실제 학원 현장의 목소리를 들으며 지속적으로 발전해왔습니다. 매년 수천 명의 학생들이 우리 시스템을 통해 효율적으로 학습하고, 학부모님들은 자녀의 학습 현황을 실시간으로 확인하실 수 있습니다. 안정성과 신뢰성이 검증된 시스템으로 학원 운영의 부담을 덜어드립니다.',
        features: [
    ...
    2: {
        ...
        text: '출결 관리, 성적 분석, 자습실 예약, 학부모 상담, 생활기록부 관리까지 학원 운영에 필요한 모든 기능이 하나의 플랫폼에 통합되어 있습니다. 더 이상 여러 개의 시스템을 오가며 데이터를 확인할 필요가 없습니다. 모든 정보가 하나의 대시보드에서 실시간으로 동기화되어 업무 효율이 크게 향상됩니다. 선생님들은 학생 지도에만 집중하실 수 있습니다.',
        features: [
    ...
    5: {
        ...
        text: '모든 데이터가 클라우드에 실시간으로 동기화되어, PC, 태블릿, 스마트폰 등 어떤 기기에서든 최신 정보를 확인할 수 있습니다. 학원에서 입력한 출결 정보를 학부모님은 즉시 스마트폰으로 확인하실 수 있으며, 선생님들도 이동 중에 학생 정보를 조회할 수 있습니다. 장소와 시간의 제약 없이 효율적으로 학원을 운영하세요.',
        features: [
    ...
    6: {
        title: '확장 가능',
        subtitle: '학원 규모에 맞춘 유연한 시스템',
        text: '소규모 학원부터 대형 프랜차이즈까지, 학원의 규모와 특성에 맞춰 시스템을 자유롭게 확장하고 커스터마이징할 수 있습니다. 초기에는 기본 기능만 사용하다가, 필요에 따라 고급 기능을 추가할 수 있으며, 학원의 특수한 요구사항에 맞춰 기능을 개발해드릴 수도 있습니다. 함께 성장하는 파트너가 되겠습니다.',
        features: [
            { icon: '🏢', title: '맞춤형', desc: '학원 규모별 맞춤 설정' },
...
console.log('🎉 학원 관리 시스템 랜딩페이지가 로드되었습니다.');
